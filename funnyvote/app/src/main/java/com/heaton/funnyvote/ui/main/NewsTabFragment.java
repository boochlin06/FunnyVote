...
@ActivityScoped
public class NewsTabFragment extends dagger.android.support.DaggerFragment implements MainPageContract.TabPageFragment {
    private static final int LIMIT = VoteDataRepository.PAGE_COUNT;
    public static String TAG = NewsTabFragment.class.getSimpleName();
    @Inject
