...
@ActivityScoped
public class FavoriteTabFragment extends dagger.android.support.DaggerFragment implements MainPageContract.TabPageFragment {
    private static final int LIMIT = VoteDataRepository.PAGE_COUNT;
    public static String TAG = FavoriteTabFragment.class.getSimpleName();
    @Inject
