...
@ActivityScoped
public class HotTabFragment extends dagger.android.support.DaggerFragment implements MainPageContract.TabPageFragment {
    private static final int LIMIT = VoteDataRepository.PAGE_COUNT;
    public static String TAG = HotTabFragment.class.getSimpleName();
    @Inject
    ...
    public HotTabFragment() {
        Log.d("test", "HotTabFragment init");
    }
