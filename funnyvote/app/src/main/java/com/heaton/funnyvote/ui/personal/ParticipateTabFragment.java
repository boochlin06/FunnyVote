...
@ActivityScoped
public class ParticipateTabFragment extends dagger.android.support.DaggerFragment implements MainPageContract.TabPageFragment {
    private static final int LIMIT = VoteDataRepository.PAGE_COUNT;
    public static String TAG = ParticipateTabFragment.class.getSimpleName();
    @Inject
