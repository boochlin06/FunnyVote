...
public class VoteDataDao extends AbstractDao<VoteData, Long> {
    ...
    public static class Properties {
        ...
        public final static Property VoteLink = new Property(2, String.class, "voteLink", false, "VOTE_LINK");
        public final static Property Title = new Property(3, String.class, "title", false, "TITLE");
        public final static Property AuthorName = new Property(4, String.class, "authorName", false, "AUTHOR_NAME");
        public final static Property AuthorCode = new Property(5, String.class, "authorCode", false, "AUTHOR_CODE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VOTE_DATA\" (" + //
                ...
                "\"VOTE_LINK\" TEXT," + // 2: voteLink
                "\"TITLE\" TEXT," + // 3: title
                "\"AUTHOR_NAME\" TEXT," + // 4: authorName
                "\"AUTHOR_CODE\" TEXT," + // 5: authorCode
    ...
    public VoteData readEntity(Cursor cursor, int offset) {
        VoteData entity = new VoteData( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // voteLink
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // title
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // authorName
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // authorCode
    ...
    public void readEntity(Cursor cursor, VoteData entity, int offset) {
        ...
        entity.setVoteLink(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setTitle(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setAuthorName(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setAuthorCode(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
